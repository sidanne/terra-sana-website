...
function Contact({ lang }) {
    ...
    const t = {
        fr: { title: "Nous contacter", sub: "Envoyez-nous un message, nous répondrons rapidement", name: "Nom complet", email: "Email", message: "Message", namePh: "Votre nom complet", emailPh: "votre@email.com", msgPh: "Votre message (minimum 20 caractères)...", btn: "Envoyer le message", sending: "Envoi en cours...", success: "Message envoyé avec succès ! Nous vous répondrons bientôt.", errName: "Le nom doit contenir au moins 3 caractères", errEmail: "Adresse email invalide", errMsg: "Le message doit contenir au moins 20 caractères" },
