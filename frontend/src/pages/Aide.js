...
const styles = { container: { padding: "40px 32px", maxWidth: "800px", margin: "0 auto", minHeight: "100vh" }, title: { fontSize: "28px", fontWeight: "bold", color: "#1a1a1a", marginBottom: "8px" }, sub: { fontSize: "14px", color: "#888", marginBottom: "32px" }, faqList: { display: "flex", flexDirection: "column", gap: "12px", marginBottom: "32px" }, faqItem: { background: "#fff", border: "1px solid #e0e0e0", borderRadius: "12px", padding: "20px", borderLeft: "4px solid #4caf50" }, faqQ: { fontSize: "15px", fontWeight: "bold", color: "#1a1a1a", marginBottom: "8px" }, faqA: { fontSize: "14px", color: "#555", lineHeight: "1.7" }, contactBox: { background: "#1a1a1a", borderRadius: "16px", padding: "32px", textAlign: "center" }, contactTitle: { fontSize: "18px", fontWeight: "bold", color: "#fff", marginBottom: "10px" }, contactDesc: { fontSize: "14px", color: "#888", marginBottom: "20px" }, contactBtn: { background: "#4caf50", color: "#fff", fontSize: "14px", padding: "10px 24px", borderRadius: "8px", textDecoration: "none", fontWeight: "600" } };
export default Aide;
