function About({ lang }) {
    const t = {
        fr: { title: "À propos de Terra Sana", mission: "Notre mission", missionText: "Terra Sana ASBL est une organisation à but non lucratif fondée en 2019 à Bruxelles. Elle soutient les producteurs locaux et promeut le circuit court.", values: "Nos valeurs", v1: "Soutien aux producteurs locaux", v2: "Promotion du circuit court", v3: "Réduction des déchets et recyclage", v4: "Accompagnement des personnes en décrochage", v5: "Encouragement des pratiques durables", team: "Notre équipe", teamText: "Notre équipe est composée d'ouvriers en réinsertion, d'employés, de bénévoles et de stagiaires.", devise: "Ils ont fait, ils font et ils feront encore, pour être fiers de ce qu'ils laisseront aux générations présentes et futures." },
    ...
    }[lang] || { title: "À propos de Terra Sana", mission: "Notre mission", missionText: "Terra Sana ASBL est une organisation a but non lucratif fondee en 2019 a Bruxelles.", values: "Nos valeurs", v1: "Soutien aux producteurs locaux", v2: "Promotion du circuit court", v3: "Reduction des dechets", v4: "Accompagnement", v5: "Pratiques durables", team: "Notre équipe", teamText: "Notre equipe est composee de benevoles et stagiaires.", devise: "Ils ont fait, ils font et ils feront encore." };
