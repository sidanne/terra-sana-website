...
const styles = {
    ...
    info: { flex: 1 },
    name: { fontSize: "14px", fontWeight: "600", color: "#1B1B1B", marginBottom: "2px" },
    email: { fontSize: "12px", color: "#2D6A4F" },
    date: { fontSize: "11px", color: "#bbb", whiteSpace: "nowrap" },
    message: { fontSize: "14px", color: "#555", lineHeight: "1.7", padding: "12px 16px", background: "#F8F4E3", borderRadius: "8px", marginBottom: "14px", borderLeft: "3px solid #e8f5e9" },
