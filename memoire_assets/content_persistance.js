...
const persistance = [
  ...
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ...
      ["username", "VARCHAR(255)", "NOT NULL, UNIQUE", "Identifiant de connexion."],
  ...
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ["id", "BIGINT", "PK, AUTO_INCREMENT", "Identifiant."],
      ["name", "VARCHAR(255)", "NULL", "Nom de l'application."],
      ["description", "VARCHAR(255)", "NULL", "Présentation."],
      ["link", "VARCHAR(255)", "NULL", "URL de l'application."],
      ["documentation_link", "VARCHAR(255)", "NULL", "URL de sa documentation."],
      ["image", "VARCHAR(255)", "NULL", "Illustration."],
      ["category", "VARCHAR(255)", "NULL", "Catégorie."],
      ["is_active", "BOOLEAN", "NULL, DEFAULT TRUE", "Visible ou non sur le hub."],
      ["created_at", "DATETIME(6)", "NULL", "Date de création."],
    ],
    [1900, 2300, 2500, 2650]),
  ...
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ["id", "BIGINT", "PK, AUTO_INCREMENT", "Identifiant."],
      ["title", "VARCHAR(255)", "NULL", "Titre de l'article."],
      ["content", "VARCHAR(5000)", "NULL", "Contenu de l'article."],
      ["image", "VARCHAR(255)", "NULL", "Illustration."],
      ["is_published", "BOOLEAN", "NULL, DEFAULT FALSE", "Publié ou brouillon."],
      ["created_at", "DATETIME(6)", "NULL", "Date de rédaction."],
    ],
    [1900, 2300, 2500, 2650]),
  ...
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ["id", "BIGINT", "PK, AUTO_INCREMENT", "Identifiant."],
      ["name", "VARCHAR(255)", "NULL", "Nom de l'expéditeur."],
      ["email", "VARCHAR(255)", "NULL", "Email de l'expéditeur."],
      ["message", "VARCHAR(5000)", "NULL", "Contenu du message."],
      ["is_read", "BOOLEAN", "NOT NULL, DEFAULT FALSE", "Traité ou non."],
      ["created_at", "DATETIME(6)", "NULL", "Date de réception."],
    ],
    [1900, 2300, 2500, 2650]),
  ...
  p("app_users porte l'ensemble du profil bénévole. Seuls quatre champs doivent être saisis par le bénévole (nom, prénom, email, mot de passe) ; level, is_active et created_at sont également obligatoires, mais alimentés automatiquement par le système, et tous les autres (téléphone, ville, compétences, disponibilités) restent facultatifs, conformément au principe de minimisation des données appliqué sur le formulaire d'inscription (section 3.4.2). Le champ level est dénormalisé à dessein : plutôt que de recalculer le niveau à chaque affichage à partir de l'historique complet des inscriptions, il est stocké et mis à jour explicitement par updateLevel() (section 3.3.3), ce qui évite de recompter les participations confirmées à chaque chargement du profil."),

  p([rt("app_users", { bold: true, color: M.GREEN_DARK }), rt(" : bénévoles")]),
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ["id", "BIGINT", "PK, AUTO_INCREMENT", "Identifiant."],
      ["first_name", "VARCHAR(100)", "NOT NULL", "Prénom du bénévole."],
      ["last_name", "VARCHAR(100)", "NOT NULL", "Nom du bénévole."],
      ["email", "VARCHAR(200)", "NOT NULL, UNIQUE", "Email de connexion (RG-01)."],
      ["password", "VARCHAR(255)", "NOT NULL", "Haché BCrypt (RG-02)."],
      ["phone", "VARCHAR(30)", "NULL", "Téléphone (facultatif)."],
      ["birth_date", "DATE", "NULL", "Date de naissance (facultative)."],
      ["gender", "VARCHAR(20)", "NULL", "Genre (facultatif)."],
      ["city", "VARCHAR(255)", "NULL", "Localité."],
      ["postal_code", "VARCHAR(20)", "NULL", "Code postal."],
      ["skills", "TEXT", "NULL", "Compétences déclarées."],
      ["availability", "VARCHAR(255)", "NULL", "Disponibilités déclarées."],
      ["preferred_language", "VARCHAR(5)", "NULL, DEFAULT 'fr'", "Langue préférée (FR/EN/NL)."],
      ["level", "ENUM('BRONZE','ARGENT','OR')", "NOT NULL, DEFAULT 'BRONZE'", "BRONZE / ARGENT / OR (RG-19)."],
      ["is_active", "BOOLEAN", "NOT NULL, DEFAULT TRUE", "Compte actif (RG-03)."],
      ["reset_token", "VARCHAR(255)", "NULL", "Jeton de réinitialisation (RG-04)."],
      ["reset_token_expiry", "DATETIME(6)", "NULL", "Expiration du jeton."],
      ["created_at", "DATETIME(6)", "NOT NULL, DEFAULT CURRENT_TIMESTAMP(6)", "Date d'inscription."],
    ],
    [1900, 2300, 2500, 2650]),
  ...
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ...
      ["description", "TEXT", "NULL", "Description complète."],
      ["event_date", "DATETIME(6)", "NOT NULL", "Date et heure (RG-05)."],
      ["location", "VARCHAR(300)", "NOT NULL", "Lieu (RG-05)."],
      ["max_places", "INT", "NOT NULL", "Nombre de places (RG-05)."],
      ["status", "ENUM('OPEN','FULL','CANCELLED','FINISHED')", "NOT NULL, DEFAULT 'OPEN'", "OPEN / FULL / CANCELLED / FINISHED (RG-06)."],
      ["image_url", "VARCHAR(500)", "NULL", "Illustration."],
      ["created_at", "DATETIME(6)", "NOT NULL, DEFAULT CURRENT_TIMESTAMP(6)", "Date de création."],
    ],
    [1900, 2300, 2500, 2650]),
  ...
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ["id", "BIGINT", "PK, AUTO_INCREMENT", "Identifiant."],
      ["status", "ENUM('WAITING','CONFIRMED','REFUSED')", "NOT NULL, DEFAULT 'WAITING'", "CONFIRMED / WAITING / REFUSED."],
      ["position", "INT", "NULL", "Position en liste d'attente (RG-10)."],
      ["created_at", "DATETIME(6)", "NOT NULL, DEFAULT CURRENT_TIMESTAMP(6)", "Date d'inscription."],
      ["user_id + event_id", "couple de colonnes", "UNIQUE", "Un bénévole ne peut avoir qu'une seule inscription par événement (RG-09)."],
    ],
    [1900, 2300, 2500, 2650]),
  ...
  table(["Champ", "Type SQL", "Contrainte", "Description"],
    [
      ...
      ["created_at", "DATETIME(6)", "NOT NULL, DEFAULT CURRENT_TIMESTAMP(6)", "Date de l'avis."],
      ["user_id + event_id", "couple de colonnes", "UNIQUE", "Un bénévole ne peut laisser qu'un seul avis par événement (RG-17)."],
    ],
    [1900, 2300, 2500, 2650]),
  caption("Table reviews — retours post-événement"),

  h3("2.2.3. Schéma physique de la base de données"),
  p("Le schéma physique découle directement du diagramme de classes et du dictionnaire de données ci-dessus : chaque entité devient une table, chaque association devient une clé étrangère avec une contrainte référentielle. La base respecte les règles de normalisation (3NF), à la seule exception assumée du champ level de la table app_users (section 2.2.2). Le script SQL complet (création des huit tables, contraintes et index) est reproduit intégralement en Annexe A ; un extrait représentatif, la création des tables events et registrations qui concentrent l'essentiel des règles de gestion, est présenté ci-dessous."),
  codeBlock([
    "CREATE TABLE events (",
  ...
  p("Deux stratégies de suppression sont appliquées de façon différenciée. ON DELETE CASCADE porte sur les clés étrangères vers app_users et events : la suppression d'un événement, ou d'un bénévole, entraîne logiquement celle de ses inscriptions et avis. En revanche, aucune cascade n'est définie vers admin : la base refuse de supprimer un administrateur encore référencé, plutôt que d'effacer en chaîne tout ce qui s'y rattache. Enfin, RG-03 impose qu'un compte bénévole soit désactivé plutôt que supprimé : la cascade depuis app_users ne s'applique donc en pratique jamais aux bénévoles actifs et ne jouerait qu'en cas de purge délibérée d'un compte."),
