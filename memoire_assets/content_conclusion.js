...
const conclusion = [
  ...
  bullet("L'absence de suite de tests automatisés (JUnit côté backend, tests de composants côté frontend) reste une lacune dans la démarche qualité, et un axe d'amélioration prioritaire si le module devait évoluer davantage. La vérification manuelle décrite en section 3.6.2, bien que systématique, ne protège pas contre une régression future introduite par inadvertance."),
